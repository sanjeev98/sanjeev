...
<head>
    ...
    <!-- Favicon icon -->
    <link rel="icon" type="image/png" sizes="16x16" href="<?php echo e(asset('asset/assets/images/favicon.png')); ?>">
    <title>Adminmart Template - The Ultimate Multipurpose admin template</title>
    <!-- Custom CSS -->
    <link href="<?php echo e(asset('asset/assets/extra-libs/c3/c3.min.css')); ?>" rel="stylesheet">
    <link href="<?php echo e(asset('asset/assets/libs/chartist/dist/chartist.min.css')); ?>" rel="stylesheet">
    <link href="<?php echo e(asset('asset/assets/extra-libs/jvector/jquery-jvectormap-2.0.2.css')); ?>" rel="stylesheet" />
    <!-- Custom CSS -->
    <link href="<?php echo e(asset('asset/dist/css/style.min.css')); ?>" rel="stylesheet">
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" href="javascript:void(0)" data-toggle="dropdown"
                           aria-haspopup="true" aria-expanded="false">
                            <img src="<?php echo e(asset('asset/assets/images/users/profile-pic.jpg')); ?>" alt="user" class="rounded-circle"
                                 width="40">
        ...
        <div class="scroll-sidebar" data-sidebarbg="skin6">
            ...
            <nav class="sidebar-nav">
                <ul id="sidebarnav">
                    ...
                    <li class="sidebar-item"> <a class="sidebar-link sidebar-link" href="<?php echo e(asset('asset/docs/docs.html')); ?>"
                                ...
                                <table class="table no-wrap v-middle mb-0">
                                    ...
                                    <tr>
                                        <td class="border-top-0 px-2 py-4">
                                            <div class="d-flex no-block align-items-center">
                                                <div class="mr-3"><img
                                                        src="<?php echo e(asset('asset/assets/images/users/widget-table-pic1.jpg')); ?>"
                                    ...
                                    <tr>
                                        <td class="px-2 py-4">
                                            <div class="d-flex no-block align-items-center">
                                                <div class="mr-3"><img
                                                        src="<?php echo e(asset('asset/assets/images/users/widget-table-pic2.jpg')); ?>"
                                                        alt="user" class="rounded-circle" width="45"
                                                        height="45" /></div>
                                                <div class="">
                                    ...
                                    <tr>
                                        <td class="px-2 py-4">
                                            <div class="d-flex no-block align-items-center">
                                                <div class="mr-3"><img
                                                        src="<?php echo e(asset('asset/assets/images/users/widget-table-pic3.jpg')); ?>"
                                                        alt="user" class="rounded-circle" width="45"
                                                        height="45" /></div>
                                                <div class="">
                                    ...
                                    <tr>
                                        <td class="px-2 py-4">
                                            <div class="d-flex no-block align-items-center">
                                                <div class="mr-3"><img
                                                        src="<?php echo e(asset('asset/assets/images/users/widget-table-pic4.jpg')); ?>"
                                                        alt="user" class="rounded-circle" width="45"
                                                        height="45" /></div>
                                                <div class="">
...
<!-- All Jquery -->
<!-- ============================================================== -->
<script src="<?php echo e(asset('asset/assets/libs/jquery/dist/jquery.min.js')); ?>"></script>
<script src="<?php echo e(asset('asset/assets/libs/popper.js/dist/umd/popper.min.js')); ?>"></script>
<script src="<?php echo e(asset('asset/assets/libs/bootstrap/dist/js/bootstrap.min.js')); ?>"></script>
<!-- apps -->
<!-- apps -->
<script src="<?php echo e(asset('asset/dist/js/app-style-switcher.js')); ?>"></script>
<script src="<?php echo e(asset('asset/dist/js/feather.min.js')); ?>"></script>
<script src="<?php echo e(asset('asset/assets/libs/perfect-scrollbar/dist/perfect-scrollbar.jquery.min.js')); ?>"></script>
<script src="<?php echo e(asset('asset/dist/js/sidebarmenu.js')); ?>"></script>
<!--Custom JavaScript -->
<script src="<?php echo e(asset('asset/dist/js/custom.min.js')); ?>"></script>
<!--This page JavaScript -->
<script src="<?php echo e(asset('asset/assets/extra-libs/c3/d3.min.js')); ?>"></script>
<script src="<?php echo e(asset('asset/assets/extra-libs/c3/c3.min.js')); ?>"></script>
<script src="<?php echo e(asset('asset/assets/libs/chartist/dist/chartist.min.js')); ?>"></script>
<script src="<?php echo e(asset('asset/assets/libs/chartist-plugin-tooltips/dist/chartist-plugin-tooltip.min.js')); ?>"></script>
<script src="<?php echo e(asset('asset/assets/extra-libs/jvector/jquery-jvectormap-2.0.2.min.js')); ?>"></script>
<script src="<?php echo e(asset('asset/assets/extra-libs/jvector/jquery-jvectormap-world-mill-en.js')); ?>"></script>
<script src="<?php echo e(asset('asset/dist/js/pages/dashboards/dashboard1.min.js')); ?>"></script>
</body>

</html>
<?php /**PATH C:\xampp\htdocs\sanjeevJ\resources\views/temp.blade.php ENDPATH**/ ?>